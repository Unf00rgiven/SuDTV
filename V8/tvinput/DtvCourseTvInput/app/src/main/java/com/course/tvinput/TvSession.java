...
public class TvSession extends TvInputService.Session {
    ...
    private IServiceCallback mServiceCallback = new IServiceCallback.Stub() {
        ...
        public void channelChangeStatus(final int routeId, boolean channelChanged, ServiceStateChangeError statusChangeError) {
            ...
            // TODO: if channel is changed successfully, send notification that video is available
        }
        ...
        public void serviceStopped(int routeId, boolean serviceStopped, ServiceStateChangeError statusChangeError) {
            ...
            // TODO: if channel is stopped successfully, send notification that video is unavailable
        }
    ...
    public void onRelease() {
        mLog.d("[onRelease]");
        resetTracks();
        // TODO: call to stop playback
        // NOTE: call mDtvEngine.stop to start channel playback
    ...
    public boolean onTune(Uri channelUri) {
        ...
        // TODO: check if requested channel exists, get it's object and request channel playback
        // NOTE: call mDtvEngine.startIp to start IP channel
        // route id can be acquired from route managher mRouteManager.getMainLiveRouteId()
