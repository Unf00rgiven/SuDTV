...
public class ChannelDescriptor {
    ...
    public ChannelDescriptor(Cursor cursor) {
        // TODO: switch existing invalid code to read all data from cursor and initialize fields
        //       use convertXYZ methods for conversion from one type to another
        // NOTE: use provided field deserialization as example for missing values
        mDisplayNumber = "XY";
        mServiceId = 1;
        mType = null;
        mServiceType = null;
        mTransportStreamId = -1;
        mNetworkId = -1;
    ...
    public ContentValues getContentValues(String inputId) {
        ...
        // TODO: serialize remaining channel descriptor fields to ContentValues
        return ret;
    }
