 ...
 *
 * FILE NAME: $URL: http://svnsrv/svn/iwedia-ext/dev/sources/chal/core/tdal/trunk/inc/tdal_output.h $
 *            $Rev: 6783 $
 *            $Date: 2013-02-04 11:08:40 +0100 (Mon, 04 Feb 2013) $
 *
...
typedef enum
{
    eTDAL_OUTPUT_VIDEO_SD_STD_NONE          = 0x00,
...
typedef enum
{
    ...
    eTDAL_OUTPUT_VIDEO_HDHMI_YCBCR444   = 0x04 /* video output YCbCr444  */
...
typedef enum
{
    eTDAL_OUTPUT_VIDEO_HD_STD_NONE              = 0x0,
    eTDAL_OUTPUT_VIDEO_HD_STD_640_480_P_60      = 0x1,
    eTDAL_OUTPUT_VIDEO_HD_STD_720_480_P_5994    = 0x2,
    eTDAL_OUTPUT_VIDEO_HD_STD_720_480_P_60      = 0x4,
    eTDAL_OUTPUT_VIDEO_HD_STD_720_480_I_5994    = 0x8,
    eTDAL_OUTPUT_VIDEO_HD_STD_720_480_I_60      = 0x10,
    eTDAL_OUTPUT_VIDEO_HD_STD_720_483_P_5994    = 0x20,
    eTDAL_OUTPUT_VIDEO_HD_STD_720_576_P_50      = 0x40,
    eTDAL_OUTPUT_VIDEO_HD_STD_720_576_I_50      = 0x80,
    eTDAL_OUTPUT_VIDEO_HD_STD_1280_720_P_2398   = 0x100,
    eTDAL_OUTPUT_VIDEO_HD_STD_1280_720_P_24     = 0x200,
    eTDAL_OUTPUT_VIDEO_HD_STD_1280_720_P_25     = 0x400,
    eTDAL_OUTPUT_VIDEO_HD_STD_1280_720_P_2997   = 0x800,
    eTDAL_OUTPUT_VIDEO_HD_STD_1280_720_P_30     = 0x1000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1280_720_P_50     = 0x2000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1280_720_P_5994   = 0x4000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1280_720_P_60     = 0x8000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1920_1080_P_2398  = 0x10000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1920_1080_P_24    = 0x20000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1920_1080_P_25    = 0x40000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1920_1080_P_2997  = 0x80000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1920_1080_P_30    = 0x100000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1920_1080_P_50    = 0x200000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1920_1080_P_5994  = 0x400000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1920_1080_P_60    = 0x800000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1920_1080_I_50    = 0x1000000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1920_1080_I_5994  = 0x2000000,
    eTDAL_OUTPUT_VIDEO_HD_STD_1920_1080_I_60    = 0x4000000,
    eTDAL_OUTPUT_VIDEO_HD_STD_3840_2160_P_24    = 0x8000000,
    eTDAL_OUTPUT_VIDEO_HD_STD_3840_2160_P_25    = 0x10000000,
    eTDAL_OUTPUT_VIDEO_HD_STD_3840_2160_P_30    = 0x20000000,
    eTDAL_OUTPUT_VIDEO_HD_STD_3840_2160_P_50    = 0x40000000,
    eTDAL_OUTPUT_VIDEO_HD_STD_3840_2160_P_60    = 0x80000000,
    eTDAL_OUTPUT_VIDEO_HD_STD_4096_2160_P_24    = 0x100000000,
    eTDAL_OUTPUT_VIDEO_HD_STD_4096_2160_P_25    = 0x200000000,
    eTDAL_OUTPUT_VIDEO_HD_STD_4096_2160_P_30    = 0x400000000,
    eTDAL_OUTPUT_VIDEO_HD_STD_4096_2160_P_50    = 0x800000000,
    eTDAL_OUTPUT_VIDEO_HD_STD_4096_2160_P_60    = 0x1000000000
...
typedef enum
{
    eTDAL_OUTPUT_AUDIO_DIGITAL_MODE_SWITCHED_BY_EDID            = 0x00000000, /* Auto */
...
typedef enum
{
    eTDAL_OUTPUT_BRIGHTNESS,
    eTDAL_OUTPUT_CONTRAST,
    eTDAL_OUTPUT_SATURATION,
    eTDAL_OUTPUT_COLORTEMPERATURE,
    eTDAL_OUTPUT_HUE
}tTDAL_OUTPUT_HDMIPictureComponent;
...
typedef struct
{
    ...
    uint64_t StandardSupportedMask;   /* bitfield of tTDAL_OUTPUT_VideoHDStandard supported */
...
IMPORT tTDAL_OUTPUT_Error TDAL_OUTPUT_HDMIParamsGet(tTDAL_OUTPUT_OutputId Id, tTDAL_OUTPUT_HDMIParams *pstParams);
IMPORT tTDAL_OUTPUT_Error TDAL_OUTPUT_HDMIParamsSet(tTDAL_OUTPUT_OutputId Id, tTDAL_OUTPUT_HDMIParams *pstParams);

IMPORT tTDAL_OUTPUT_Error TDAL_OUTPUT_HDMIPictureParamsSet(tTDAL_OUTPUT_OutputId Id, tTDAL_OUTPUT_HDMIPictureComponent eComponent, uint16_t value);
IMPORT tTDAL_OUTPUT_Error TDAL_OUTPUT_HDMIPictureParamsGet(tTDAL_OUTPUT_OutputId Id, tTDAL_OUTPUT_HDMIPictureComponent eComponent, uint16_t *value);
