 ...
 *
 * FILE NAME:   TDAL_TS.H
 *   $URL: http://svnsrv/svn/iwedia-ext/dev/sources/chal/core/tdal/trunk/inc/tdal_ts.h $
 *   $Rev: 14893 $
 *   $Date: 2014-10-03 14:28:21 +0200 (Fri, 03 Oct 2014) $
 *
 * PUBLIC
 *
...
/* Available modes to send TS to player: SOCKET (1) or FIFO (2) or Tuner WRITE (3) */
#define kTDAL_TSMERGE_SEND_TS_TO_PLAYER_VIA_SOCKET	1
#define kTDAL_TSMERGE_SEND_TS_TO_PLAYER_VIA_FIFO	2
#define kTDAL_TSMERGE_SEND_TS_TO_PLAYER_VIA_WRITE	3

#define TDAL_TSMERGE_SEND_TS_TO_PLAYER_MODE		kTDAL_TSMERGE_SEND_TS_TO_PLAYER_VIA_WRITE
#endif   /* PRODUCT_USE_CIMAX_DEVICE */
...
typedef struct TDAL_TSSINK_Status_s {
    ...
    uint32_t    pts_ms;     /* presentation timestamp in miliseconds (zero offset) */
...
typedef enum
{
    eTDAL_TSSOURCE_STREAM_TYPE_VIDEO,
    eTDAL_TSSOURCE_STREAM_TYPE_AUDIO,
    eTDAL_TSSOURCE_STREAM_TYPE_TELETEXT,
    eTDAL_TSSOURCE_STREAM_TYPE_SUBTITLE,
    eTDAL_TSSOURCE_STREAM_TYPE_PCR,
    eTDAL_TSSOURCE_STREAM_TYPE_PSI,
    eTDAL_TSSOURCE_STREAM_TYPE_TP,
    eTDAL_TSSOURCE_STREAM_TYPE_UNKNOWN
}
tTDAL_TSSOURCE_StreamType;
//~mudri
...
/* callback function called to notify client application of the TS byterate */
typedef void (* tTDAL_TSSOURCE_ByterateCallbackFct )(
    tTDAL_TSSOURCE_Handle   handle,
    void *                  client_tag,
    uint32_t                byterate
);
...
GLOBAL tTDAL_TSSOURCE_Error TDAL_TSSOURCE_AddPid(
                                ...
                                tTDAL_TSSOURCE_StreamType stream_type
                            );
...
GLOBAL  tTDAL_TSSOURCE_Error  TDAL_TSSOURCE_RemovePid(
            ...
            /* Remove all PIDs from an extraction */
GLOBAL tTDAL_TSSOURCE_Error   TDAL_TSSOURCE_RemoveAllPids(
		                        tTDAL_TSSOURCE_Handle  handle
		                      );
...
GLOBAL tTDAL_TSSOURCE_Error TDAL_TSSOURCE_SetByterateCallback
                               (tTDAL_TSSOURCE_Handle              handle,
                                tTDAL_TSSOURCE_ByterateCallbackFct byterate_callback,
                                void                               *client_tag);

GLOBAL tTDAL_TSSOURCE_Error TDAL_TSSOURCE_SetByterateValue(tTDAL_TSSOURCE_Handle handle,
                                                           uint32_t              byterate);
