 ...
 *
 * FILE NAME:   TDAL_FS.H
 *   $URL: http://svnsrv/svn/iwedia-ext/dev/sources/chal/core/tdal/trunk/inc/tdal_fs.h $
 *   $Rev: 13735 $
 *   $Date: 2014-06-04 16:55:26 +0200 (Wed, 04 Jun 2014) $
 *
 * DESCRIPTION
 *
 *****************************************************************************/
...
#define kTDAL_FS_MODE_RDWR     0x04
#define kTDAL_FS_MODE_APPEND   0x08
#define kTDAL_FS_MODE_TRUNC    0x10
#define kTDAL_FS_MODE_CREATE   0x20
#define kTDAL_FS_MODE_EXCL     0x40
...
/** File System Information **/
    ...
    tTDAL_FS_Error TDAL_FS_SetVolumePath(char * pPath);

    tTDAL_FS_Error TDAL_FS_GetVolumePath(char **ppPath);
