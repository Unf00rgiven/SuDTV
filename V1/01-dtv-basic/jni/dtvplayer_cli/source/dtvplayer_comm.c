...
tCliCommands gCliCommands[] =
{
    ...
    {"hello",   DtvPlayer_Execute_Hello,		"Use this command to print hello message."},
    // TODO: Add one more command called 'hello' that will print out some greeting string in stardard output
    // NOTE 1: Pay attention to syntac for adding commands
    // NOTE 2: Fn parameters should be same as in code above
    // NOTE 3: Add new command on the bottom of the file
};
...
void DtvPlayer_Execute_Hello(size_t argc, char** argv) {
    printf("Hello! Welcome to the DTV Player application.\n");
}
